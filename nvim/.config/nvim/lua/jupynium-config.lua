...
--  Creating a custom command for JupyniumStartSync for convenience

vim.api.nvim_create_user_command(
   "Js",
   function(opts) vim.cmd("JupyniumStartSync " .. opts.args) end,
   { nargs = 1 }
)

vim.api.nvim_create_user_command(
   "Jl",
   function(opts) vim.cmd("JupyniumLoadFromIpynbTab " .. opts.args) end,
   { nargs = 1 }
)
